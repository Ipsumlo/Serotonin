...
TARGET_SYSROOT = $(shell xcrun -sdk iphoneos15.0 --show-sdk-path)
...
Serotonin.tipa: $(wildcard **/*.c **/*.m **/*.swift **/*.plist **/*.xml)
	...
	xcodebuild clean build -project Serotonin.xcodeproj -sdk iphoneos15.0 -configuration Release CODE_SIGN_IDENTITY="" CODE_SIGNING_REQUIRED=NO CODE_SIGNING_ALLOWED="NO"
